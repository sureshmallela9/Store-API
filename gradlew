...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    ROOTDIRSRAW=`find -L / -maxdepth 3 -type d -name gradle 2>/dev/null | head -10`
    SEP=""
...
# Collect all arguments for the java command, following the shell argument syntax:
#   * args from the command line
#   * the main class name
#   * -classpath
#   * -D...appname settings
...
# Regular expression for matching strings from the gradle.properties file.
# You should update this regular expression to support a wider set of strings
# For example, you could use: [a-zA-Z_][a-zA-Z0-9_]*
PATTERN="^[a-zA-Z_][a-zA-Z0-9_.-]*=.*"

# Only attempt to set APP_HOME if GRADLE_HOME is not set AND java_home it IS set
